...
export default function SignUp() {
  ...
  <meta name="description" content="Sign up for ibuyr to access AI-driven property price predictions and real estate deals." />
      ...
      {/* <video
        ...
        /> */}
      <div
        className={`bg-blue-100 md:bg-blue-200 relative flex flex-wrap  mt-24 w-full md:w-fit m-auto rounded-3xl h-300px transition-all duration-[2000ms] ${
          animate ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"
        }`}
      >
        <div
          className={`z-10 p-10 max-w-lg mx-auto bg-black flex-1 rounded-3xl m-2 md:ml-2 mr-2 ml-2 text-white transition-all duration-[2000ms] ${
            animate
        ...
        >
          ...
          <br />
          <p>
            Explore a vast collection of properties tailored to your lifestyle.
            From cozy apartments to luxurious villas, we make finding your
            perfect home effortless.
          </p>
          ...
          <h4 className="text-xl">
            Begin your journey to better living today!
          </h4>
        </div>
        ...
        <div className=" z-10 p-20 pt-5 max-w-lg mx-auto  flex-1 w-full md:w-auto ">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <input
              type="text"
              placeholder="email"
              className="p-3 rounded-lg border-solid bg-blue-100 border-black border-2"
              id="email"
              onChange={handleChange}
            />
            ...
            <input
              ...
              className="border-solid border-black bg-blue-100 border-2 p-3 rounded-lg"
              id="password"
              onChange={handleChange}
            />

            <button className="bg-black text-white p-3 rounded-lg hover:opacity-95 disabled:opacity-80">
